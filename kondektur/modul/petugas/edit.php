  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="?m=petugas"><i class="fa fa-user"></i> Profil</a></li>
...
?>
			 ...
			 <form action="?m=petugas&s=update" method="post" enctype="multipart/form-data">
              <table id="pilkasis1" class="table table-bordered table-hover table-striped">
                <tbody>
          <input type="text" name="id" hidden size="25px" maxlength="25px" value="<?php echo$r['id_petugas'];?>" required />
          <tr>
						<td width=150>Nama Petugas</td>
						<td><input class="form-control" type="text" name="nama_lengkap" placeholder="Nama Petugas" size="25px" maxlength="50px" value="<?php echo$r['nama_lengkap'];?>" required /></td>
					</tr>
          <tr>
