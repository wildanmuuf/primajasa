...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../css/dist/css/skins/skin-red.css">
    <!-- iCheck -->
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="../images/kustomer/<?php echo $r['foto']; ?>" class="user-image" alt="<?php echo $r['username']; ?>">
                  <small><?php echo $r['nama_lengkap']; ?></small>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="../images/kustomer/<?php echo $r['foto']; ?>" class="img-circle" alt="<?php echo $r['nama_lengkap']; ?>">
                    <p>
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="?m=kustomer&s=profil" class="btn btn-default btn-flat">Profile</a>
                    </div>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="../images/kustomer/<?php echo $r['foto']; ?>" class="img-circle" alt="<?php echo $_SESSION['username']; ?>">
            </div>
            <div class="pull-left info">
              <p><?php echo $r['nama_lengkap']; ?></p>
              <a href="?m=kustomer&s=profil"><i class="fa fa-circle text-success"></i> Online</a>
            </div>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php if($aktif=='Riwayat Pesanan') echo 'active';?> treeview">
              <a href="?m=riwayat_pesanan">
                <i class="fa fa-history"></i> <span>Riwayat Pesanan</span>
              </a>
            </li>
            <li class="<?php if($aktif=='Pembayaran') echo 'active';?> treeview">
              <a href="?m=pembayaran">
                <i class="fa fa-money-bill-alt"></i> <span>Riwayat Pembayaran</span>
              </a>
            </li>
            <li>
              <a href="logout.php">
